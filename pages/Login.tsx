      ...
      <header className="w-full flex items-center justify-between whitespace-nowrap border-b border-gray-200 dark:border-gray-800 px-6 lg:px-20 py-4 bg-white dark:bg-[#162a2d]">
        ...
        <div className="flex flex-1 justify-end gap-6 items-center">
          <div className="hidden md:flex items-center gap-6">
            <a className="text-[#0d1a1c] dark:text-gray-300 text-sm font-medium hover:text-primary transition-colors" href="#">Help Desk</a>
            <a className="text-[#0d1a1c] dark:text-gray-300 text-sm font-medium hover:text-primary transition-colors" href="#">Technical Support</a>
          </div>
          <button type="button" className="flex min-w-[100px] items-center justify-center rounded-lg h-10 px-4 bg-primary text-white text-sm font-bold hover:bg-opacity-90 transition-all">
            Contact IT
          </button>
        </div>
      </header>
            ...
            <div className="p-8">
              ...
              <div className="mt-8 pt-6 border-t border-gray-100 dark:border-gray-800 text-center">
                ...
                <p className="text-gray-500 dark:text-gray-400 text-xs">
                  Having trouble? Visit our <a className="text-primary hover:underline" href="#">Knowledge Base</a> or contact the system administrator.
                </p>
              </div>
            </div>
          </div>
