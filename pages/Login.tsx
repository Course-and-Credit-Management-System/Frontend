      ...
      <div className="bg-white dark:bg-slate-950 min-h-screen flex flex-col font-poppins transition-colors duration-500 relative overflow-hidden">
        <header className="w-full flex items-center justify-between whitespace-nowrap border-b border-slate-100 dark:border-slate-800 px-8 lg:px-24 py-6 bg-white/80 dark:bg-slate-950/80 backdrop-blur-md z-50">
          <div className="flex items-center gap-4 text-teal-600">
            ...
            <h2 className="text-slate-900 dark:text-white text-2xl font-black tracking-tight">{t('UniPortal')}</h2>
          </div>
          <LanguageSwitcher />
        </header>
          ...
          <div className="max-w-[520px] w-full flex flex-col gap-10 animate-in fade-in duration-1000 slide-in-from-bottom-8">
            <div className="bg-white dark:bg-slate-900 shadow-2xl rounded-[48px] border border-slate-100 dark:border-slate-800 p-12 relative overflow-hidden transition-all hover:shadow-teal-500/5">
              ...
              <div className="flex flex-col items-center mb-12">
                ...
                <h1 className="text-4xl font-black text-slate-900 dark:text-white tracking-tight mb-2">{t('Protocol Access')}</h1>
                <p className="text-sm font-medium text-slate-400 dark:text-slate-500">{t('Secure entry to institutional resources')}</p>
              </div>
              ...
              <form className="space-y-8" onSubmit={handleSubmit}>
                <div className="space-y-3 group">
                  <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1 transition-colors group-focus-within:text-teal-600">{t('Institutional ID')}</label>
                ...
                <div className="space-y-3 group">
                  <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1 transition-colors group-focus-within:text-teal-600">{t('Authorization Key')}</label>
                  <div className="relative">
                ...
                <div className="flex items-center justify-between py-2">
                  <label className="flex items-center gap-3 cursor-pointer group">
                    ...
                    <span className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest group-hover:text-slate-600 transition-colors">{t('Persist Session')}</span>
                  </label>
