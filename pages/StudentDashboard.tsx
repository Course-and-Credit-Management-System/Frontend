      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6 lg:p-8 relative">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-8 gap-4">
            <div>
              <h2 className="text-3xl font-bold text-gray-800 dark:text-white">Welcome back, {user.name}! 👋</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <div className="bg-surface-light dark:bg-surface-dark p-5 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm flex flex-col justify-between">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">Full-time • {currentCredits !== null ? `${currentCredits} Credits` : "- Credits"}</p>
            </div>
            ...
            <div className="bg-surface-light dark:bg-surface-dark p-5 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm flex flex-col justify-between">
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  <h3 className="text-2xl font-bold mt-1 text-gray-800 dark:text-white">{gpa !== null ? gpa.toFixed(2) : "-"}</h3>
                </div>
