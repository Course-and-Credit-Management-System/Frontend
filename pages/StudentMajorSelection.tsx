        ...
        <main className="flex-1 overflow-y-auto p-10 lg:p-16 scrollbar-hide animate-in fade-in duration-700 slide-in-from-bottom-4">
          <div className="max-w-6xl mx-auto">
            ...
            {eligibility && !eligibility.can_select_major ? (
              <div className="rounded-[40px] border border-dashed border-slate-200 dark:border-slate-800 p-12 text-center animate-in zoom-in-95">
                <div className="h-20 w-20 rounded-[32px] bg-slate-50 dark:bg-slate-950 flex items-center justify-center text-slate-300 dark:text-slate-700 mx-auto mb-8 border border-slate-100 dark:border-slate-800">
                  <span className="material-icons-outlined text-4xl">event_busy</span>
                </div>
                <h3 className="text-2xl font-black text-slate-900 dark:text-white mb-2 tracking-tight">Window Terminated</h3>
                <p className="text-sm font-medium text-slate-400 max-w-md mx-auto leading-relaxed">
                  {eligibility.reason || "Access to the specialization matrix is restricted during the current academic interval."}
                </p>
              </div>
            ) : (
