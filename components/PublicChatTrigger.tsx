...
const PublicChatTrigger: React.FC = () => {
  ...
  // Hide on chatbot page and course detail pages
  if (location.pathname === "/student/chatbot" || hideOnCourseDetail) {
    return null;
  }
...
export default PublicChatTrigger;